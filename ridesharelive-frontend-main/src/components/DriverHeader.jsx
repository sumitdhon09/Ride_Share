  ...
  return (
    <motion.header
      ...
      className={`relative overflow-hidden rounded-[2rem] border p-5 shadow-[0_32px_90px_-48px_rgba(8,145,178,0.2)] ${
        isDark
          ? "border-[rgba(45,60,87,0.78)] bg-[linear-gradient(180deg,rgba(5,12,24,0.95),rgba(9,18,34,0.9))]"
          : "border-slate-200 bg-white/96 shadow-[0_28px_70px_-42px_rgba(14,165,233,0.22)]"
      }`}
    >
        ...
        <div className="grid gap-3 sm:grid-cols-[auto_auto_auto] sm:items-center">
          <motion.button
            ...
            className={`flex items-center gap-3 rounded-full border px-4 py-3 text-sm font-semibold transition ${
              online
                ? isDark
                  ? "border-cyan-400/30 bg-cyan-400/[0.1] text-cyan-100 shadow-[0_0_24px_rgba(34,211,238,0.18)]"
                  : "border-sky-200 bg-sky-50 text-sky-700 shadow-[0_0_24px_rgba(14,165,233,0.14)]"
                : isDark
                  ? "border-slate-700/70 bg-[#0f1a2d] text-slate-300"
          ...
          <div className={`rounded-[1.35rem] border px-4 py-3 ${isDark ? "border-[rgba(41,56,83,0.82)] bg-[#0d182b]/82" : "border-slate-200 bg-slate-50"}`}>
          ...
          <button
            ...
            className={`relative grid h-12 w-12 place-items-center rounded-2xl border ${isDark ? "border-slate-700/70 bg-[#0f1a2d] text-slate-200 shadow-[0_14px_28px_-20px_rgba(15,23,42,0.62)]" : "border-slate-200 bg-slate-50 text-slate-700"}`}
          >
